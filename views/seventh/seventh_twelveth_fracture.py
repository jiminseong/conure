...
def display_page7_12():
    ...
    st.markdown(f'<img src="data:image/png;base64,{img_base64}" alt="발뼈 이미지" style="width:100%; max-width:600px;">', unsafe_allow_html=True)

    st.markdown("발 또는 발목에 골절이 예상되는 부위를 선택해주세요.")
    symptom_options = [
        "목말뼈",
        "발배뼈",
        "쐐기뼈",
    ...
    if submit:
        ...
        #     model="gpt-4",
        # )
        st.write(f"아픈 부위: 발-{selected_symptom}")

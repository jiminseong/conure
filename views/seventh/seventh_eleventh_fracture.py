...
def display_page7_11():
    ...
    st.markdown(f'<img src="data:image/png;base64,{img_base64}" alt="다리뼈 이미지" style="width:100%; max-width:600px;">', unsafe_allow_html=True)

    st.markdown("다리에 골절이 예상되는 부위를 선택해주세요.")
    symptom_options = [
        "대퇴골",
        "슬개골",
        "종아리뼈",
    ...
    if submit:
        ...
        #     model="gpt-4",
        # )
        st.write(f"아픈 부위: 골반-{selected_symptom}")

...
def display_page7_10():
    ...
    st.markdown(f'<img src="data:image/png;base64,{img_base64}" alt="골반 이미지" style="width:100%; max-width:600px;">', unsafe_allow_html=True)

    st.markdown("골반에 골절이 예상되는 부위를 선택해주세요.")
    symptom_options = [
        "두덩결합",
        "두덩뼈,"
        "궁둥뼈",

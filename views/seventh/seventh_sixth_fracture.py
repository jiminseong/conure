...
def display_page7_6():
    ...
    st.markdown(f'<img src="data:image/png;base64,{img_base64}" alt="쇄골 이미지" style="width:100%; max-width:600px;">', unsafe_allow_html=True)

    # 증상 선택 옵션 제공
    st.markdown("쇄골 부근에 골절이 예상되는 부위를 선택해주세요.")
    symptom_options = [
        "쇄골",
        "견봉쇄골 관절",
        "견봉",
    ...
    if submit:
        ...
        #     model="gpt-4",
        # )
        st.write(f"아픈 부위: 쇄골 부근-{selected_symptom}")

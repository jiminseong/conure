...
def display_page5_2():
    ...
    if submit:
        ...
        #         {
        #             "role": "system",
        #             "content": f"이 사용자는 일반인이며 어려운 설명은 이해하기 어려울 수 있습니다. 현재 FirstAID라는 인공지능 api 사용 웹에서 치아 손상진단을 위해 접근하였습니다. 구체적으로 행동요령과 구급처치법을 설명해 주세요. 그리고 이 환자의 문제가 발생한 부분은 {selected_tooth}이며 증상은 {selected_symptom}입니다. 구체적인 증상은 사용자가 입력한 텍스트를 확인하십시오.",
        #         },
        #     ],
        #     model="gpt-4",
        # )
